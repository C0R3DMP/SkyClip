...
This document explains how to migrate ClipCascade from H2 (default) to PostgreSQL.
...
- Start ClipCascade configured to use PostgreSQL
...
- ClipCascade service with PostgreSQL configuration
...
- Other ClipCascade settings (see main docker-compose.yml)

---

## Troubleshooting

### ClipCascade fails to start: "CC_DB_PASSWORD must be set"
...
### PostgreSQL not ready when ClipCascade starts
...
For questions or issues, refer to the ClipCascade GitHub repository.
