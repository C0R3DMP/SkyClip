...
if PLATFORM.startswith(LINUX):
    ...
    try:
        ...
        print(f"skyclip (Linux CLI): {e}", file=sys.stderr)
        sys.exit(2)
...
if PLATFORM == WINDOWS:
    ...
    if XMODE:
        APP_VERSION = "1.0.0"  # gui version
    else:
        APP_VERSION = "1.0.0"  # non-gui(cli) version
...
VERSION_URL = "https://raw.githubusercontent.com/C0R3DMP/SkyClip/main/version.json"
RELEASE_URL = "https://github.com/C0R3DMP/SkyClip/releases/latest"
GITHUB_URL = "https://github.com/C0R3DMP/SkyClip"
APP_NAME = "SkyClip"
HELP_URL = f"{GITHUB_URL}/blob/main/README.md"
METADATA_URL = "https://raw.githubusercontent.com/C0R3DMP/SkyClip/main/metadata.json"

if PLATFORM == WINDOWS:
    MUTEX_NAME = "Global\\SkyClip_Mutex_PSSR"
elif PLATFORM == MACOS or PLATFORM.startswith(LINUX):
    MUTEX_NAME = "skyclip.lock"
...
def get_program_files_directory():
    ...
    if PLATFORM == MACOS:
        app_dir = os.path.join(
            get_user_home_directory(), "Library", "Application Support", "SkyClip"
        )
